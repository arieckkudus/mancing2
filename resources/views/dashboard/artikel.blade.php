            ...
            <div class="card shadow-sm mt-4">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between mb-3 flex-wrap">
                        <form action="{{ route('dashboard.artikel') }}" method="GET" class="d-flex mb-2"
                            ...
                            <tbody>
                                @forelse ($artikel as $key => $item)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($item->pict)
                                                <img src="{{ asset($item->pict) }}" alt="Thumbnail"
                                        ...
                                        <td>
                                            ...
                                            @if (empty($item->accept))
                                                <form action="{{ route('dashboard.artikel-delete', $item->id) }}" method="POST"
