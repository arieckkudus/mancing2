...
@section('content')
    ...
    <div class="app-content p-md-3 p-lg-4">
        <div class="container-fluid px-0">
            <div class="card shadow-sm">
                <div class="card-body">
                    <form class="settings-form" action="{{ route('daftar-anggota-usaha.store') }}" method="POST"
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" id="nomor_izin_usaha" name="nomor_izin_usaha"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" id="nomor_telepon_usaha"
                                    name="nomor_telepon_usaha" placeholder="Masukkan Nomor Telepon Usaha">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="website_usaha" name="website_usaha"
                                    placeholder="Masukkan website anda jika ada">
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="nama_penanggung_jawab"
                                    name="nama_penanggung_jawab" placeholder="Masukkan nama usaha">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <label for="nomor_telepon_penanggung" class="form-label">Nomor Telepon Penanggung
                                    jawab</label>
                                <input type="number" class="form-control" id="nomor_telepon_penanggung"
                                    name="nomor_telepon_penanggung" placeholder="Contoh: 2015">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="mt-2">
                                    <button type="button" class="btn btn-sm btn-danger"
                                        id="clear_signature_usaha">Clear</button>
                                </div>
                            ...
                            <div class="p-0">
                                <ul>
                                    <li>Saya telah membaca, memahami, dan menyetujui Anggaran Dasar (AD) dan Anggaran Rumah
                                        Tangga (ART) Asosiasi
                                        Permancingan Indonesia serta peraturan-peraturan lain yang berlaku di dalamnya.</li>
                                    <li>.Saya bersedia untuk aktif berpartisipasi dalam kegiatan-kegiatan Asosiasi
                                        Permancingan
                                        Indonesia sesuai dengan
                                        kemampuan dan minat saya.</li>
                                    <li>Saya akan menjunjung tinggi nama baik Asosiasi Permancingan Indonesia dan menjaga
                                        etika
                                        serta integritas sebagai
                                        anggota.</li>
                                    <li>Saya akan memenuhi kewajiban sebagai anggota sesuai dengan ketentuan yang berlaku.
                                    </li>
                                    <li>Saya memberikan izin kepada Asosiasi Permancingan Indonesia untuk menyimpan dan
                                        menggunakan data pribadi saya
                                        sesuai dengan kebijakan privasi yang berlaku untuk kepentingan organisasi.</li>
                                    <li>Saya menyadari bahwa keanggotaan saya dapat ditinjau atau dihentikan sesuai dengan
                                        ketentuan AD/ART Asosiasi
    ...
    <script>
        ...
        document.getElementById('clear_signature_usaha').addEventListener('click', function () {
