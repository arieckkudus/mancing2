...
<div class="container py-5">
  <div class="card shadow">
    ...
    <div class="card-body">
      ...
      <form class="settings-form" action="{{ route('daftar-anggota-komunitas.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row g-3">
          ...
          <div class="col-md-6">
            ...
            <div class="col-md-6">
              ...
              <textarea class="form-control" name="fokus_kegiatan" id="fokus_kegiatan" rows="1"></textarea>
            </div>
